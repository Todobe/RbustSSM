...
run: RobustSSM
	...
	./RobustSSM ./data/Video_game_network.txt ./data/Video_game_task.txt -tau 0 -alg OMegA  -o omega.txt -k 29
	./RobustSSM ./data/Video_game_network.txt ./data/Video_game_task.txt -tau -1 -alg check -result ./result/OMegA.txt -k 29 -o omega.txt
	./RobustSSM ./data/Video_game_network.txt ./data/Video_game_task.txt -tau -1 -alg Sequence -result ./resul/Sequence.txt -k 29
#
